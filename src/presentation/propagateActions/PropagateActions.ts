...
import {
  getBankAccountInfoByBankToken,
  getUserOrdersOnABank,
  registerUserOrdersOnABank
} from '../../core/data-sources/bank'
import {getAllUsers} from '../../core/data-sources/user'
import {investmentConfig} from '../../core/use-cases/bank/BankInvestmentsLogical'
import {BanksList, UserModel} from '../../core/use-cases/user/createUserUC'


export async function handler(event: APIGatewayEvent, context: Context, _callback: Callback) {
